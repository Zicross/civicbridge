...
- Name: intake.spec.ts >> Public Intake Flow >> representative list shows source/as-of/confidence
- Location: tests/e2e/intake.spec.ts:29:3
...
Call log:
  ...
  - waiting for getByText(/source:/i)
