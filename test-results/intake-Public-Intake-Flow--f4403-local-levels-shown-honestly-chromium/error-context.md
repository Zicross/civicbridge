...
- Name: intake.spec.ts >> Public Intake Flow >> unsupported local levels shown honestly
- Location: tests/e2e/intake.spec.ts:38:3
...
Locator: getByText(/local|county|city/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/local|county|city/i)
