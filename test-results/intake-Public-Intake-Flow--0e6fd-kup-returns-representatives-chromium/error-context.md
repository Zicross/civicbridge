...
- Name: intake.spec.ts >> Public Intake Flow >> address lookup returns representatives
- Location: tests/e2e/intake.spec.ts:20:3
...
Locator: getByRole('heading', { name: /representatives/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /representatives/i })

```

```yaml
- main:
  - heading "ConstiuINT" [level=1]
  - paragraph: Constituent Intelligence — Structured Civic Feedback
  - paragraph: ConstiuINT helps you provide structured feedback to your representatives. Enter your address to see who represents you at the federal and state levels, then submit your feedback for ConstiuINT review.
  - text: Your Address
  - textbox "Your Address":
    - /placeholder: 1600 Pennsylvania Avenue NW, Washington, DC 20500
    - text: 1600 Pennsylvania Avenue NW, Washington, DC 20500
  - paragraph: Enter your address to find your representatives at the federal and state levels.
  - button "Find My Representatives" [disabled]
```
